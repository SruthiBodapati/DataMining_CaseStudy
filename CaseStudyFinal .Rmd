...
## reading the dataset
```{r}
German <- read.csv("C:/Users/Sreeraj/Downloads/GermanCredit.csv")
missing(German) #dataset is checked for any missing value
View(German)
str(German)
```
...
valid_data_tree <- NEW_German[-training_rows,]
...
```{r}
library("neuralnet")
NN_German <- read.csv("C:/Users/Sreeraj/Downloads/GermanCredit.csv")
